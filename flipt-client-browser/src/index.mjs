...
class Engine {
    ...
    */
    constructor(namespace, data) {
        ...
        const ret = wasm.engine_new(ptr0, len0, addHeapObject(data));
    ...
    */
    snapshot(data) {
        wasm.engine_snapshot(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {any} request
    * @returns {any}
    */
    evaluate_boolean(request) {
        try {
            ...
            wasm.engine_evaluate_boolean(retptr, this.__wbg_ptr, addHeapObject(request));
    ...
    */
    evaluate_variant(request) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.engine_evaluate_variant(retptr, this.__wbg_ptr, addHeapObject(request));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('flipt_engine_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
...
var flipt_engine_wasm = /*#__PURE__*/Object.freeze({
	__proto__: null,
	Engine: Engine,
	default: __wbg_init,
	initSync: initSync
...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(flipt_engine_wasm);

Object.defineProperty(src, "__esModule", { value: true });
var FliptEvaluationClient_1 = src.FliptEvaluationClient = void 0;
const flipt_engine_wasm_js_1 = require$$0;
...
FliptEvaluationClient_1 = src.FliptEvaluationClient = FliptEvaluationClient;

export { FliptEvaluationClient_1 as FliptEvaluationClient, src as default };
